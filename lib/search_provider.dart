...
class SearchProvider extends ChangeNotifier {
  ...
  Autogenerated? searchmeal;
  setIsLoading(bool value) {
    isLoading = value;
    notifyListeners();
  }

  Future<void> searchPro() async {
    try {
      setIsLoading(true);
      item = controller1.text;
      final responce = await http.get(Uri.parse(
          "https://www.themealdb.com/api/json/v1/1/search.php?s=$item"));

      if (responce.statusCode == 200) {
        searchmeal = welcomeFromJson(responce.body);

        print(responce.body);
        print(searchmeal?.meals?.length);
      } else {
